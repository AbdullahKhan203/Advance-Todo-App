      ...
      <Form>
        ...
        <Form.Group className="mb-2">
          ...
          >
            ...
            <option value="Shopping">Deletagted</option>
          </Form.Select>
        </Form.Group>
    ...
    {editingTodo && (
      <Form>
        ...
        <Form.Group className="mb-2">
          ...
          >
            {Array.from(new Set(todos.map((t) => t.status))).map((status) => (
        ...
        <Form.Group className="mb-2">
          ...
          >
            {Array.from(new Set(todos.map((t) => t.catagory))).map(
              (cat) => (
        ...
        <Form.Group className="mb-2">
          ...
          >
            {Array.from(new Set(todos.map((t) => t.priority))).map(
              (pri) => (
